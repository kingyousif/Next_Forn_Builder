...
import WageCalculatorModal from "@/components/attendance/WageCalculatorModal";
...
export default function AttendanceTracking() {
  ...
  const handleWageUpdate = useCallback((wageInfo) => {
    setWageData(wageInfo);
  }, []);
      ...
      <div className="container mx-auto p-6 space-y-8">
        <Card className="shadow-2xl border-0 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl transition-all duration-500 hover:shadow-3xl">
          <CardHeader className="pb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 dark:from-blue-500 dark:via-purple-500 dark:to-indigo-500 text-white rounded-t-xl">
            ...
            {/* Enhanced Total Hours Display with Late, Early, Extra Time, and Wage */}
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8 gap-4">
              ...
              {/* New Wage Statistics */}
              {wageData && (
                <div className="bg-emerald-500/20 backdrop-blur-sm rounded-lg p-4 text-center border border-emerald-300/30">
                  <div className="text-2xl font-bold text-emerald-100">
                    {new Intl.NumberFormat("ar-IQ", {
                      ...
                      .format(wageData.totalWage)
                      .replace("IQD", "دينار")}
                  </div>
                  <div className="text-sm opacity-90">Total Wage</div>
                  <div className="text-xs opacity-75">
                    (
                    {new Intl.NumberFormat("ar-IQ", {
                      style: "currency",
